...
<footer class="defaultFooter">
    <div class="defaultFooter-container">
        ...
        <div class="defaultFooter-nav defaultFooter-item">
            ...
            <nav class="defaultFooter-links" aria-label="support navigation">
                ...
                <a class="defaultFooter-link" href='https://www.escrow.com/learn-more' data-target="footer-learn-more">Learn More</a>
            </nav>
        </div>
        ...
        <div class="defaultFooter-contact defaultFooter-item">
            <nav class="defaultFooter-links" aria-label="company navigation">
                ...
                <a class="defaultFooter-link" href='https://www.escrow.com/why-escrowcom/about-us' data-target="footer-leadership">Leadership</a>
                ...
                <a href="tel:+1-415-801-2270" class="defaultFooter-contactLink" data-tracking-section="footer" data-tracking-label="support-phone-number">
                <span class="defaultFooter-contactIcon">
    ...
    <div class="defaultFooter-corporate">
        ...
        <div role="contentinfo">
            <div class="defaultFooter-copyright"><a class="defaultFooter-copyrightLink" href='https://www.escrow.com/escrow-101/copyright-and-trademark-information' data-target="footer-copyright">Copyright</a> © 1999-2018 Escrow.com, Inc. All rights reserved</a>
            </div>
        </div>
</footer>
...
olark.identify('2962-347-10-5881');/*]]>*/</script><noscript><a href="https://www.olark.com/site/2962-347-10-5881/contact" title="Contact us" target="_blank">Questions? Feedback?</a> powered by <a href="http://www.olark.com?welcome" title="Olark live chat software">Olark live chat software</a></noscript>
<!-- end olark code -->
<script> olark.configure('system.group', 'f6d37fc20876d4b393a4731eef928ef2'); /*Routes to General Support*/ </script>



<script>
    olark('api.chat.updateVisitorStatus', {snippet: 'Customer profile page: https://admin.internal.escrow.com/olarktoken.asp?TokenType=OlarkCustomerProfile&CustomerId=2586135&Token=17b2f3b6-e774-494e-a6ed-83cece2aa4d8'});
    olark('api.visitor.updateCustomFields', {
        customer_id: '2586135',
        token: '17b2f3b6-e774-494e-a6ed-83cece2aa4d8'
    });

</script>

<script src="/JsScripts/TrackingFrame.js?v=1" type="text/javascript"></script>
<script type="text/javascript">
    TrackingFrame.init('https://www.escrow.com');
</script>
<iframe src="https://www.escrow.com/tracking-frame" style="display:none;" id="tracking-iframe"></iframe>
<script type="text/javascript">
    setTimeout(function () {
...
<script type="text/javascript">window.fingerprint_config = {url: 'https://device.escrow.com/v1/fingerprint', property: 'escrow', reference: 2586135};</script>
<script async src="https://device.escrow.com/build/deviceid.js" type="text/javascript"></script>
