    ...
    <div class="section-container">
      <div class="grid grid--verticalCenter">
        <div class="grid-col grid-col--desktopSmall-7">
          ...
          <div class="getStarted-desc">  <p class="getStarted-desc">Not sure if your transaction can be covered? Call our friendly support team on <a href="tel:+1-415-801-2270" class="getStarted-phone" data-tracking-section="upsell" data-tracking-label="support-phone-number">+1-415-801-2270</a> to find out</p></div>
        </div>
